...
class BeerDataModule(pl.LightningDataModule):
    ...
    def __init__(self, *,train_df,
        ...
        self.train_data_file_name= 'beer_train_data4.npy'
        self.user_grouped_data_file_name = 'beer_user_group_df4.pkl'
        self.args=args
    ...
    def gen_train_data(self, user_grouped_df):
        pos_train_df = self.train_df[[USER_INDEX, ITEM_INDEX]]
        pos_train_df.loc[:, RATING_ID] = 1
        print('stack neg items')
        neg_train_df = user_grouped_df[TRAIN_NEG_ITEM_LIST] \
        ...
        print('sparse KEY_VECTOR')
        train_df[TRAIN_POS_P_LIST] = train_df[USER_INDEX] \
        ...
        train_vec = train_df[TRAIN_POS_P_LIST].apply(pd.Series).values
        print('concat')
