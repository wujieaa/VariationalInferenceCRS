...
def main():
    ...
    if (path.exists(result_path)):
        ...
        return
    item_result=data[CEVNCFLightning.FINAL_OUTPUTS_ITEM]
    base_dir=r'd:\data'
    ...
    #-----------explanation------------
    explaination_result = data[CEVNCFLightning.FINAL_OUTPUTS_EXPLAINATION]
    ...
    #-----------critiquing------------
    critiquing_result = data[CEVNCFLightning.FINAL_OUTPUTS_CRITIQUING]
