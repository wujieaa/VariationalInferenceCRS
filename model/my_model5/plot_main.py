...
from model.my_model4.ce_bvae_lightning import CEVILightning
import argparse
import os
...
def main(args):
    ...
    item_result=data[CEVILightning.FINAL_OUTPUTS_ITEM]
    ...
    #-----------explanation------------
    explaination_result = data[CEVILightning.FINAL_OUTPUTS_EXPLAINATION]
    ...
    #-----------critiquing------------
    critiquing_result = data[CEVILightning.FINAL_OUTPUTS_CRITIQUING]
    ...
    keyphrase_loss_result = data[CEVILightning.FINAL_OUTPUTS_KEYPHRASE_AVGLOSS]
